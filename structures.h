...
typedef enum types{						/*definition of instruction rows type*/
	CODE, DATA, ENTRY, EXT, JUMP
}types;
typedef enum address {					/*definition of operands address type*/
	NO_ADDRESS = -1, DIRECT = 1<<0, IMMEDIATE = 1<<1, DIRECT_REG = 1<<2
}address;
